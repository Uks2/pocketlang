...
typedef PkHandle* (*pkNewModule_t)(PKVM*, const char*, const char*, int);
...
typedef PkHandle* (*pkNewClass_t)(PKVM*, const char*, PkHandle*, PkHandle*, pkNewInstanceFn, pkDeleteInstanceFn, const char*, const char*, int);
...
typedef PkHandle* (*pkGetSlotHandle_t)(PKVM*, int, const char*, int);
...
PkNativeApi pkMakeNativeAPI() {
  ...
  api.pkGetSlotHandle_ptr = pkGetSlotHandle_;
